...
// Update LINKEDIN_URL to your own profile.
export const GITHUB_URL = "https://github.com/Sauham/Founders-Room";
export const LINKEDIN_URL = "https://www.linkedin.com/in/sauham-vyas";

export default function SocialLinks({ size = 22 }: { size?: number }) {
  return (
